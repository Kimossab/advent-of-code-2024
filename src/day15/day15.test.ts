...
describe("Day 15: Warehouse Woes", { concurrency: true }, () => {
  ...
  before(async () => {
    ...
    ({ day15: day } = await import("./day15"));
  });

  describe.skip("Part 1", () => {
    it("should return 10092", async () => {
      const input = `##########
#..O..O.O#
#......O.#
#.OO..O.O#
...
`;
      ...
      assert.equal(result.part1, 10092);
    });
    it("should return 2028", async () => {
      const input = `########
#..O.O.#
##@.O..#
#...O..#
...
`;
      ...
      assert.equal(result.part1, 2028);
    });
  });

  describe("Part 2", () => {
    it("should return 618", async () => {
      const input = `#######
#...#.#
#.....#
#..OO@#
...
`;
      ...
      assert.equal(result.part2, 618);
    });

    it("should return 9021", async () => {
      const input = `##########
#..O..O.O#
#......O.#
#.OO..O.O#
...
`;
      ...
      assert.equal(result.part2, 9021);
    });
  });
});
